...
class ResConfigSettings(models.TransientModel):
    ...
    enable_category_wise_discount = fields.Boolean(string='Category discount limit',readonly=False,
    ...
    def _set_is_enable_category_wise_discount(self):
        """Setting is_enable_category_wise_discount in selected categories in current POS."""
    ...
    def get_values(self):
        ...
        enable_category_wise_discount = icp_sudo.get_param('res.config.settings.enable_category_wise_discount')
        res.update(enable_category_wise_discount=enable_category_wise_discount,
        )
        return res
