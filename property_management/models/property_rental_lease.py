...
class PropertyRentalLease(models.Model):
    ...
    total_amount = fields.Float(string="Total Amount", compute="", store=True)
    attachment_ids = fields.Many2many('ir.attachm_compute_total_amountent', compute='_compute_attachments')
